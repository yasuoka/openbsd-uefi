...
# $FreeBSD: head/sys/boot/efi/boot1/generate-fat.sh 281526 2015-04-14 13:55:01Z andrew $
...
echo '# $FreeBSD: head/sys/boot/efi/boot1/generate-fat.sh 281526 2015-04-14 13:55:01Z andrew $' >> Makefile.fat
...
echo '$FreeBSD: head/sys/boot/efi/boot1/generate-fat.sh 281526 2015-04-14 13:55:01Z andrew $' >> $OUTPUT_FILE.bz2.uu
